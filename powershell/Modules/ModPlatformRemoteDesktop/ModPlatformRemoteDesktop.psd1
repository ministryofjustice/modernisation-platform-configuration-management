...
NestedModules = @('ModPlatformRDGateway.psm1', 
               'ModPlatformRDLicensing.psm1', 
               'ModPlatformRDServices.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Add-ModPlatformRDGateway', 'Set-ModPlatformRDGatewayCAP', 
               'Set-ModPlatformRDGatewayRAP', 
               ...
               'Add-ServerFqdnListToServerList'
