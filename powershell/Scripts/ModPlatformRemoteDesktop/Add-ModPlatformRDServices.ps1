...
$GlobalConfig = @{
  ...
  "pd-rds-1-a"   = @{
    ...
    "Collections"         = @{
      "CAFM-RDP" = @{
        "SessionHosts"  = @("PD-CAFM-A-11-A.AZURE.HMPP.ROOT", "PD-CAFM-A-12-B.AZURE.HMPP.ROOT", "PD-CAFM-A-13-A.AZURE.HMPP.ROOT", "PD-CAFM-A-14-B.AZURE.HMPP.ROOT", "PD-CAFM-A-15-A.AZURE.HMPP.ROOT")
        "Configuration" = @{
