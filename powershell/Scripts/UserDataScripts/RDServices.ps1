$GlobalConfig = @{
  ...
  "pd-rds-1-a" = @{
    ...
    "SessionHostServers" = @("PP-CAFM-A-11-A.azure.hmpp.root", "PP-CAFM-A-12-B.azure.hmpp.root", "PP-CAFM-A-13-A.azure.hmpp.root")
    "WebAccessServer" = "$env:computername.AZURE.HMPP.ROOT"
    "Collections" = @{
      "CAFM-RDP" = @{
        "SessionHosts" = @("PP-CAFM-A-11-A.azure.hmpp.root", "PP-CAFM-A-12-B.azure.hmpp.root", "PP-CAFM-A-13-A.azure.hmpp.root")
        "Configuration" = @{
          "CollectionDescription" = "PlanetFM RemoteDesktop App Collection"
          "UserGroup" = @("HMPP\PROD_CAFM_admins")
        }
