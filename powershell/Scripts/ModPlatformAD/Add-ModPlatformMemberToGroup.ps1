<#
    .SYNOPSIS
        Joins a user or object to a group in Active Directory
    .DESCRIPTION
        Joins a user or object to a group in Active Directory
    .PARAMETER Group
...
param (
    ...
    [psobject]$Group,
    [Parameter(Mandatory=$true)]
    [string]$Member, # Adjusts the base domain DN as necessary
    [Parameter(Mandatory=$true)]
...
Add-ModPlatformGroupMember -Group $Group -Member $Member -ModPlatformADCredential $ADCredential
