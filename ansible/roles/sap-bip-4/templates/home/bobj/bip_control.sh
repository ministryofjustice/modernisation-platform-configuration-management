...
GAP_SECS=0
BIPRWS_LOGON_TOKEN=
LBS="{{ sap_bip_lb_public_name }} {{ sap_bip_lb_private_name }}"
FORMAT=default
LOGPREFIX=
...
set_env_variables() {
  PUBLIC_LB_NAME={{ sap_bip_lb_public_name }}
  PUBLIC_LB_RULE_MAINTENANCE_PRIORITY=999
  PUBLIC_LB_PORT=443
  PUBLIC_LB_BACKEND_PORT=7777
  PRIVATE_LB_NAME={{ sap_bip_lb_private_name }}
