CREATE OR REPLACE PACKAGE MIS_GEN_PKG AUTHID DEFINER AS
/*
 ...
 */
    ...
    g_mis_owner 	VARCHAR2(30) := SYS_CONTEXT('USERENV', 'CURRENT_USER');
--    g_queue_owner 	VARCHAR2(30) := SYS_CONTEXT('USERENV', 'CURRENT_USER');
    ...
    g_ogg_capture 	VARCHAR2(30) := 'AUDRFCAP';
    g_capture_name VARCHAR2(30) := 'OGG$CAP_'||g_ogg_capture;
    g_capture_queue_name VARCHAR2(30) := 'OGG$Q_'||g_ogg_capture;

    g_ogg_replicat VARCHAR2(30) := 'AUDRFAPP';
